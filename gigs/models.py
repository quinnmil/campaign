...
class Job(models.Model):
    ...
    initial_count = models.IntegerField('Initial number of jobs available', default=0)
    ...
    pay = models.DecimalField('Pay for completed job', max_digits=5, decimal_places=2)
